...
SELECT CT1.MATD , CT1.MADOI +' - '+CT2.MADOI AS [TRẬN ĐẤU] ,CAST (CT1.SOBANTHANG AS CHAR(2))+ ' - ' + CAST (CT2.SOBANTHANG AS CHAR(2)) AS [TỈ SỐ]
...
SELECT CONCAT(D1.MADOI,D2.MADOI)
FROM DOI D1 , DOI D2 
WHERE D1.MADOI > D2.MADOI 
EXCEPT 
SELECT CONCAT(CT1.MADOI,CT2.MADOI)
FROM CT_TRANDAU CT1 , CT_TRANDAU CT2 
WHERE  CT1.MATD = CT2.MATD  AND CT1.MADOI > CT2.MADOI AND 
CONCAT(CT2.MADOI,CT1.MADOI) NOT LIKE CONCAT(CT1.MADOI,CT2.MADOI)
